...
public class UserService {
	...
	public User validate(String email, String password) {
		StringBuilder criteria = new StringBuilder().append("WHERE email = :email AND password = :password");
	...
	public boolean save(User user) {
		StringBuilder isExist = new StringBuilder().append("WHERE email = :email");
		Map<String, Object> params = new HashMap<String, Object>();
		...
		if (users.size() == 0) {
			...
			StringBuilder criteria = new StringBuilder().append("WHERE name = 'user'");
